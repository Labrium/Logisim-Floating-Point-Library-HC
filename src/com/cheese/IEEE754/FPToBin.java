...
public class FPToBin extends InstanceFactory {
	...
	public void paintInstance(InstancePainter painter) {
		...
		GraphicsUtil.drawCenteredText(painter.getGraphics(), "2I", bds.getX() + bds.getWidth()/2, bds.getY() + bds.getHeight()/2);
	}

	@Override
	public void propagate(InstanceState state) {
		state.setPort(1, FloatHelper.floatValueToValue(state.getPortValue(0)), 1);
	}
